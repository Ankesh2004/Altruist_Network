...
const PaperRoundLeft = ({ DATA }: { DATA: WhyDecentralizationDataTypes }) => {
  return (
    ...
    <div className="p-4 rounded-l-full text-right shadow-md shadow-primaryColor bg-primaryColor w-full lg:w-[80%]">
      <h2 className="text-xl font-bold text-secondaryDarkColor">
        {DATA.heading}
      </h2>
      <div className="max-w-[92%] flex flex-col text-right">
